...
# BOSSES
bosses = ["AirBoss", "EarthBoss", "FireBoss", "IceBoss", "LightningBoss"]
for b in bosses:
...
# MINIBOSSES
minibosses = ["SuperArcher", "SuperCoffin", "SuperKnight", "SuperLancer", "SuperMage", "SuperRogue", "SuperSummoner"]
for m in minibosses:
...
# CHEST MILESTONES
for elem in elements:
    _add_multiple_locations(f"{elem} Chest Slot", 20, "Chests")
...
for count in chest_milestones:
    _add_location(f"Open {count} Total Chests", "Milestones")
