...
item_table: Dict[str, WoLItemData] = {
    ...
    "Outfit: Avarice":          WoLItemData("Outfits", 871121005, ItemClassification.useful),
    "Outfit: Spirit":           WoLItemData("Outfits", 871121006, ItemClassification.useful),
    ...
    "Outfit: Shift":            WoLItemData("Outfits", 871121009, ItemClassification.useful),
